...
<fieldset>
    ...
    <div class="widget fluid">
        ...
        {{ Form::nyelect('category', array(AccountCategory::ITEM => 'Item', AccountCategory::ACCOUNTING => 'Accounting', ), isset($account['category']) ? $account['category'] : AccountCategory::ACCOUNTING, 'Category') }}
